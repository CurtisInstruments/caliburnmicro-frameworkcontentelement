namespace Caliburn.Micro.FrameworkContentElement
{
    ...
    public static class BindingScope {
        ...
        public static System.Windows.FrameworkContentElement FindName(this IEnumerable<System.Windows.FrameworkContentElement> elementsToSearch, string name)
        {
#if WinRT
        ...
        /// <summary>
        /// Gets all the <see cref="System.Windows.FrameworkContentElement"/> instances with names in the scope.
        /// </summary>
        /// <returns>Named <see cref="System.Windows.FrameworkContentElement"/> instances in the provided scope.</returns>
        /// <remarks>Pass in a <see cref="DependencyObject"/> and receive a list of named <see cref="System.Windows.FrameworkContentElement"/> instances in the same scope.</remarks>
        public static Func<DependencyObject, IEnumerable<System.Windows.FrameworkContentElement>> GetNamedElements = elementInScope =>
        {
        ...
        /// <summary>
        /// Finds a set of named <see cref="System.Windows.FrameworkContentElement"/> instances in each hop in a <see cref="ScopeNamingRoute"/>.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        public static Func<ScopeNamingRoute, IEnumerable<System.Windows.FrameworkContentElement>> FindNamedDescendants = routeHops =>
        {
            if (routeHops == null) {
            ...
            var descendants = new List<System.Windows.FrameworkContentElement>();
            var queue = new Queue<DependencyObject>();
            queue.Enqueue(routeHops.Root);

            while (queue.Count > 0) {
                var current = queue.Dequeue();
                var currentElement = current as System.Windows.FrameworkContentElement;
